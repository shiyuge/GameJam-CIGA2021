...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(UnityEngine.UI.Text)).AddExtendType(typeof(DG.Tweening.DOTweenModuleUI)),
        _GT(typeof(UnityEngine.UI.Image)).AddExtendType(typeof(DG.Tweening.DOTweenModuleUI)),
