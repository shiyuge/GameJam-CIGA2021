...
namespace Emmy
{
    ...
    public class ToLuaEmmyAPIGenerator
    {
        ...
        static void DoIt()
        {
            ...
            var directory = Directory.CreateDirectory(Application.dataPath+"/Lua/toLuaEmmy");
            ...
            Debug.LogFormat("API 生成完毕. {0}", directory);
        }
    }
    ...
    class LuaAPIGenerator : CodeGenerator
    {
        ...
        public override void Gen(BindType bt)
        {
            ...
            string fileName = string.Format(Application.dataPath+"/Lua/toLuaEmmy/{0}Wrap.lua", bt.wrapName);
