...
---@overload fun(getter:DG.Tweening.Core.DOGetter, setter:DG.Tweening.Core.DOSetter, endValue:int, duration:float):DG.Tweening.Core.TweenerCore
---@overload fun(getter:DG.Tweening.Core.DOGetter, setter:DG.Tweening.Core.DOSetter, endValue:uint, duration:float):DG.Tweening.Core.TweenerCore
---@overload fun(getter:DG.Tweening.Core.DOGetter, setter:DG.Tweening.Core.DOSetter, endValue:long, duration:float):DG.Tweening.Core.TweenerCore
---@overload fun(getter:DG.Tweening.Core.DOGetter, setter:DG.Tweening.Core.DOSetter, endValue:ulong, duration:float):DG.Tweening.Core.TweenerCore
