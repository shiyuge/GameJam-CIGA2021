...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(QContent.UpdateChildrenCallbackDelegate), factory.QContent_UpdateChildrenCallbackDelegate);
		dict.Add(typeof(QContent.InitDelegate), factory.QContent_InitDelegate);
		...
		DelegateTraits<QContent.UpdateChildrenCallbackDelegate>.Init(factory.QContent_UpdateChildrenCallbackDelegate);
		DelegateTraits<QContent.InitDelegate>.Init(factory.QContent_InitDelegate);
		...
		TypeTraits<QContent.UpdateChildrenCallbackDelegate>.Init(factory.Check_QContent_UpdateChildrenCallbackDelegate);
		TypeTraits<QContent.InitDelegate>.Init(factory.Check_QContent_InitDelegate);
		...
		StackTraits<QContent.UpdateChildrenCallbackDelegate>.Push = factory.Push_QContent_UpdateChildrenCallbackDelegate;
		StackTraits<QContent.InitDelegate>.Push = factory.Push_QContent_InitDelegate;
	}
	...
	class QContent_UpdateChildrenCallbackDelegate_Event : LuaDelegate
	{
		public QContent_UpdateChildrenCallbackDelegate_Event(LuaFunction func) : base(func) { }
		public QContent_UpdateChildrenCallbackDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public QContent.UpdateChildrenCallbackDelegate QContent_UpdateChildrenCallbackDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			QContent.UpdateChildrenCallbackDelegate fn = delegate(int param0, UnityEngine.Transform param1) { };
			return fn;
		}

		if(!flag)
		{
			QContent_UpdateChildrenCallbackDelegate_Event target = new QContent_UpdateChildrenCallbackDelegate_Event(func);
			QContent.UpdateChildrenCallbackDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			QContent_UpdateChildrenCallbackDelegate_Event target = new QContent_UpdateChildrenCallbackDelegate_Event(func, self);
			QContent.UpdateChildrenCallbackDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_QContent_UpdateChildrenCallbackDelegate(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(QContent.UpdateChildrenCallbackDelegate), L, pos);
	}

	void Push_QContent_UpdateChildrenCallbackDelegate(IntPtr L, QContent.UpdateChildrenCallbackDelegate o)
	{
		ToLua.Push(L, o);
	}

	class QContent_InitDelegate_Event : LuaDelegate
	{
		public QContent_InitDelegate_Event(LuaFunction func) : base(func) { }
		public QContent_InitDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public QContent.InitDelegate QContent_InitDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			QContent.InitDelegate fn = delegate() { };
			return fn;
		}

		if(!flag)
		{
			QContent_InitDelegate_Event target = new QContent_InitDelegate_Event(func);
			QContent.InitDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			QContent_InitDelegate_Event target = new QContent_InitDelegate_Event(func, self);
			QContent.InitDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_QContent_InitDelegate(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(QContent.InitDelegate), L, pos);
	}

	void Push_QContent_InitDelegate(IntPtr L, QContent.InitDelegate o)
	{
		ToLua.Push(L, o);
	}
